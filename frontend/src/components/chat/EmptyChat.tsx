...
export default function EmptyChat({ onSuggestionClick }: EmptyChatProps) {
  return (
    <div className="flex flex-1 flex-col items-center px-6 min-h-0 overflow-y-auto py-8 lg:justify-center">
      <div className="flex flex-col items-center w-full max-w-2xl mx-auto my-auto py-4">
        <motion.div
